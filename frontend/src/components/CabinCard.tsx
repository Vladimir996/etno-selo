...
export default function CabinCard({ cabin }: { cabin: LocalizedCabin }) {
  ...
  return (
    <div className="group overflow-hidden rounded-2xl border border-wood-700/15 bg-cream-100 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
      ...
      <div className="p-6">
        <h3 className="font-serif text-xl font-semibold text-forest-950">{cabin.name}</h3>
        <p className="mt-2 text-sm leading-relaxed text-forest-900/70">{cabin.shortDescription}</p>
